...
# r = 3*n*n/1000-2*n*n*n/1000/1000
...
scoreboard players operation #v_1 pl_sys *= #n3 pl_sys
...
scoreboard players operation #v_fd_t0 pl_sys *= #v_fd_n pl_sys
scoreboard players operation #v_fd_t0 pl_sys *= #v_fd_n pl_sys
scoreboard players operation #v_fd_t0 pl_sys /= #n500000 pl_sys
